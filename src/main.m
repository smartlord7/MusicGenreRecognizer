...
% PCA
[coeff, score, latent] = pca_data(features); % Eu meti isto em função, mas nem deve ser necessário, mas tou a normalizar la dentro para testar so
...
figure;plot(cumsum(latent)./total_variance*100,'o-')
xlabel('Principal component')
ylabel('% of variance')
