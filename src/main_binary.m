...
for i=(1:size(Const.FUNCTIONS_NORMALIZATION, 2))
    ...
    for j=(1:size(target_labels))
        ...
        for k = 1:Const.N_PARTITIONS
            ...
            [predicted_train, predicted_test] = random_forest_classifier(sT, sV);
            [mse, accuracy, specificity, sensitivity, f_measure, auc] = eval_classifier(val_data_partitionY, predicted_test', Const.LABELS_BINARY, "rf" + genre + "_" + norm_function + string(k));
...
writetable(results_table, 'rf.xlsx');
